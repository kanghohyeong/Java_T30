...
public class HomePage extends JPanel{
	...
	HomePage() {
		...
		manual_button.addActionListener(new ManualButtonClickListener());
...
//	}
	...
	class ManualButtonClickListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			Music click_sound = new Music("click",false);
			click_sound.start();
			Main.main_frame.getContentPane().removeAll();
			Main.main_frame.getContentPane().add(new ManualPage());
			Main.main_frame.repaint();
		}
